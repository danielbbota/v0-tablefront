...
export const translations = {
  ...
  pain_4_body: {
    ...
    DE: "Schlechte Google-Sichtbarkeit und veraltete Plattformen machen Sie angreifbar. Ein stärkerer Online-Konkurrent kann über Nacht einen plötzlichen Rückgang bei Buchungen und Laufkundschaft verursachen.",
    PT: "Fraca visibilidade no Google e plataformas desatualizadas deixam-no exposto. Um concorrente mais forte online pode causar uma queda repentina nas reservas e no movimento de um dia para o outro.",
  },
  ...
  pricing_summary_sub: {
    ...
    PT: "Resumo em tempo real com base nas suas seleções acima.",
  },
  pricing_empty: {
  ...
  pricing_note: {
    ...
    DE: "Alle Preise in Schweizer Franken (CHF) · 7-Tage-Build ab Materialeingang · Keine versteckten Gebühren",
    PT: "Todos os preços em Francos Suíços (CHF) · Construção em 7 dias após receção dos materiais · Sem taxas ocultas",
  },
  pricing_note_2: {
    EN: "Final price confirmed after understanding your full scope. This page was prepared for you after our call.",
    DE: "Endpreis wird nach Verständnis Ihres vollständigen Umfangs bestätigt. Diese Seite wurde nach unserem Gespräch für Sie vorbereitet.",
  ...
  pricing_scope_toggle: {
    ...
    DE: "Vollständige Umfangsregeln anzeigen — monatliche Updates, Limits & Ausschlüsse",
    PT: "Ver regras de âmbito completas — atualizações mensais, limites e exclusões",
  },
  pricing_var_note: {
    EN: "+ Per-update cost quoted separately (from CHF 80)",
    DE: "+ Kosten pro Update werden separat angeboten (ab CHF 80)",
    PT: "+ Custo por atualização cotado separadamente (a partir de CHF 80)",
  },
  ...
  plan_onetime_note: {
    ...
    DE: "Der Basisaufbau enthält ein sauberes PDF-Menü, das Gäste öffnen und herunterladen können — einfach, schnell, professionell. Vollständiges visuelles Menü als Add-on verfügbar (+CHF 500).",
  ...
  plan_sub6_commitment: {
    EN: "6-month commitment. Cancel after.",
    DE: "6-monatige Bindung. Danach kündbar.",
  ...
  plan_sub6_note: {
    ...
    DE: "Basis enthält PDF-Menü. Fügen Sie die vollständige visuelle Menüintegration für +CHF 500 Aufbaugebühr und +CHF 60/Monat für Updates hinzu. Enthält 1 Menü- & Inhaltsaktualisierung pro Vertragszeitraum.",
    PT: "Base inclui menu PDF. Adicione integração de menu visual completo por +CHF 500 de taxa de construção e +CHF 60/mês para atualizações. Inclui 1 atualização de menu e conteúdo por período de contrato.",
  },
  plan_sub12_label: {
  ...
  plan_sub12_note: {
    ...
    DE: "Basis enthält PDF-Menü. Fügen Sie die vollständige visuelle Menüintegration für +CHF 500 Aufbaugebühr und +CHF 60/Monat für Updates hinzu. Enthält 2 Menü- & Inhaltsaktualisierungen pro Vertragszeitraum.",
    PT: "Base inclui menu PDF. Adicione integração de menu visual completo por +CHF 500 de taxa de construção e +CHF 60/mês para atualizações. Inclui 2 atualizações de menu e conteúdo por período de contrato.",
  },
  plan_sub12_extra: {
  ...
  feat_local_seo: {
    EN: "Local SEO setup",
    DE: "Lokale SEO-Einrichtung",
    PT: "Configuração de SEO local",
  },
  feat_analytics: {
  ...
  scope_always_included: {
    ...
    DE: "Immer in monatlichen Paketen enthalten",
    PT: "Sempre incluído nos planos mensais",
  },
  scope_limited: {
    EN: "Limited — visual menu subscribers only",
    DE: "Begrenzt — nur für Abonnenten des visuellen Menüs",
    PT: "Limitado — apenas assinantes do menu visual",
  },
  scope_never: {
    EN: "Never included — quoted separately",
    DE: "Nie enthalten — separat angeboten",
    PT: "Nunca incluído — cotado separadamente",
  },
  scope_item_1: {
    EN: "6-month plan: 1 menu & content update included per contract period",
    DE: "6-Monats-Paket: 1 Menü- & Inhaltsaktualisierung pro Vertragszeitraum enthalten",
  ...
  scope_item_2: {
    ...
    DE: "12-Monats-Paket: 2 Menü- & Inhaltsaktualisierungen pro Vertragszeitraum enthalten",
  ...
  scope_item_3: {
    ...
    DE: "Bearbeitung von Öffnungszeiten und Kontaktdaten",
    PT: "Edições de horários de funcionamento e dados de contacto",
  },
  scope_item_4: {
  ...
  scope_item_5: {
    ...
    DE: "Vollständige Menüumgestaltung oder -umstrukturierung zählt als 1 vollständige Aktualisierung",
    PT: "Redesign ou reestruturação completa do menu conta como 1 atualização completa",
  },
  scope_item_6: {
    EN: "Adding entirely new menu sections or categories counts as 1 full update",
    DE: "Das Hinzufügen völlig neuer Menüabschnitte oder -kategorien zählt als 1 vollständige Aktualisierung",
  ...
  scope_item_7: {
    ...
    DE: "Vollständige Foto-Neuaufnahmen, die umfangreiche Bildarbeit erfordern, zählen als 1 vollständige Aktualisierung",
  ...
  scope_item_8: {
    ...
    DE: "Neue Seiten außerhalb des ursprünglichen Umfangs",
    PT: "Novas páginas além do âmbito original",
  },
  scope_item_9: {
    EN: "E-commerce, online ordering or loyalty systems",
    DE: "E-Commerce, Online-Bestellungen oder Treueprogramme",
  ...
  scope_item_11: {
    ...
    PT: "Integrações de software POS ou contabilidade",
  },
  scope_item_12: {
  ...
  addon_visual_menu_desc: {
    ...
    DE: "Jedes Gericht und Getränk direkt in die Seite integriert — Fotos, Beschreibungen, Allergene und Preise. Gäste durchstöbern Ihr Menü wie ein Magazin, kein PDF erforderlich.",
    PT: "Cada prato e bebida construído diretamente no site — fotos, descrições, alergénios e preços. Os clientes navegam no seu menu como uma revista, sem necessidade de PDF.",
  },
  addon_visual_menu_scope: {
    ...
    DE: "Abonnementkunden: +CHF 60/Monat deckt monatliche Updates ab (Preisänderungen, saisonale Wechsel, Foto-Ersatz). Vollständige Menüumstrukturierungen auf 2× pro Jahr begrenzt.",
    PT: "Clientes de assinatura: +CHF 60/mês cobre atualizações mensais (alterações de preços, trocas sazonais, substituições de fotos). Reestruturações completas de menu limitadas a 2× por ano.",
  },
  addon_visual_menu_sub_badge: {
    EN: "+ CHF 60/mo for updates on subscription",
    DE: "+ CHF 60/Monat für Updates bei Abonnement",
    PT: "+ CHF 60/mês para atualizações na assinatura",
  },
  addon_emergency_label: {
    EN: "48-Hour Emergency Launch",
    DE: "48-Stunden-Notfall-Launch",
    PT: "Lançamento de Emergência em 48 Horas",
  },
  addon_emergency_price: {
    EN: "+CHF 800",
    DE: "+CHF 800",
    PT: "+CHF 800",
  },
  addon_emergency_desc: {
    ...
    PT: "Reabertura após renovação ou perdeu o seu site? Ficamos live em 48 horas para que a sua reputação não seja afetada.",
  },
  addon_guarantee_label: {
    EN: "30-Day Money-Back Guarantee",
    DE: "30-Tage-Geld-zurück-Garantie",
    PT: "Garantia de Devolução do Dinheiro em 30 Dias",
  },
  addon_guarantee_price: {
    EN: "+CHF 600",
    DE: "+CHF 600",
    PT: "+CHF 600",
  },
  addon_guarantee_desc: {
    ...
    DE: "Nicht zufrieden innerhalb von 30 Tagen? Volle Rückerstattung. Wir sind selbstbewusst genug in unserer Arbeit, um das Risiko zu tragen.",
    PT: "Não está satisfeito em 30 dias? Reembolso total. Temos confiança suficiente no trabalho para assumir o risco.",
  },
  addon_monthly_update_label: {
    EN: "Monthly Update Service",
    DE: "Monatlicher Update-Service",
    PT: "Serviço de Atualização Mensal",
  },
  addon_monthly_update_price: {
    EN: "+CHF 79/mo",
    DE: "+CHF 79/Monat",
    PT: "+CHF 79/mês",
  },
  addon_monthly_update_desc: {
    ...
    DE: "Menüänderungen, Specials, Fotos, Öffnungszeiten — schnell erledigt, kein Login erforderlich. Ideal für Besitzer, die Inhalte regelmäßig aktualisieren.",
    PT: "Alterações de menu, especiais, fotos, horários — tratados rapidamente, sem necessidade de login. Ideal para proprietários que atualizam conteúdo regularmente ao longo do ano.",
  },
  addon_monthly_update_scope: {
    EN: "Covers: price edits, seasonal swaps, photo replacements, PDF menu swaps. Full menu restructures: max 2× per year.",
    DE: "Umfasst: Preisänderungen, saisonale Wechsel, Foto-Ersatz, PDF-Menü-Austausch. Vollständige Menüumstrukturierungen: max. 2× pro Jahr.",
    PT: "Cobre: edições de preços, trocas sazonais, substituições de fotos, trocas de menu PDF. Reestruturações completas de menu: máx. 2× por ano.",
  },
  addon_monthly_update_tag: {
    EN: "One-time plan only",
    DE: "Nur für Einmalpakete",
  ...
  addon_ondemand_desc: {
    ...
    DE: "Benötigen Sie ein zusätzliches Update über Ihr enthaltenes Kontingent hinaus oder sind Sie in einem Einmalpaket? Zahlen Sie pro Update basierend auf dem Umfang. Keine monatliche Bindung.",
    PT: "Precisa de uma atualização extra além da sua cota incluída, ou está num plano único? Pague por atualização com base no âmbito. Sem compromisso mensal.",
  },
  addon_ondemand_scope: {
    EN: "Final price confirmed before each update based on what needs changing.",
    DE: "Endpreis wird vor jeder Aktualisierung basierend auf dem, was geändert werden muss, bestätigt.",
    PT: "Preço final confirmado antes de cada atualização com base no que precisa ser alterado.",
  },
  addon_support60_label: {
    EN: "60-Day Post-Launch Support",
    DE: "60-Tage-Support nach dem Launch",
    PT: "Suporte Pós-Lançamento de 60 Dias",
  },
  addon_support60_price: {
    EN: "+CHF 400",
    DE: "+CHF 400",
    PT: "+CHF 400",
  },
  addon_support60_desc: {
    EN: "Dedicated support and weekly check-in calls for 60 days after launch. Zero surprises, zero stress.",
    DE: "Dedizierter Support und wöchentliche Check-in-Anrufe für 60 Tage nach dem Launch. Keine Überraschungen, kein Stress.",
  ...
  addon_reports_desc: {
    ...
    DE: "Monatlicher Bericht mit Besucherzahlen, Top-Seiten und Reservierungskonversion — damit Sie die Ergebnisse in echten Zahlen sehen können.",
    PT: "Relatório mensal mostrando números de visitantes, páginas principais e conversão de reservas — para que possa ver os resultados em números reais.",
  },
} as const
